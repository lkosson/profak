...
namespace ProFak.UI
{
	partial class DeklaracjaVatEdytor
	{
		...
		private void InitializeComponent()
		{
			...
			this.numericUpDownNettoZW = new NumericUpDownDPI();
			this.numericUpDownNetto0 = new NumericUpDownDPI();
			this.numericUpDownNetto5 = new NumericUpDownDPI();
			this.numericUpDownNalezny5 = new NumericUpDownDPI();
			this.numericUpDownNetto8 = new NumericUpDownDPI();
			this.numericUpDownNalezny8 = new NumericUpDownDPI();
			this.numericUpDownNetto23 = new NumericUpDownDPI();
			this.numericUpDownNalezny23 = new NumericUpDownDPI();
			this.numericUpDownNettoWDT = new NumericUpDownDPI();
			this.numericUpDownNettoWNT = new NumericUpDownDPI();
			this.numericUpDownNaleznyWNT = new NumericUpDownDPI();
			...
			this.numericUpDownNaliczonyPrzeniesiony = new NumericUpDownDPI();
			this.numericUpDownNettoSrodkiTrwale = new NumericUpDownDPI();
			this.numericUpDownNaliczonySrodkiTrwale = new NumericUpDownDPI();
			this.numericUpDownNettoPozostale = new NumericUpDownDPI();
			this.numericUpDownNaliczonyPozostale = new NumericUpDownDPI();
			this.numericUpDownNettoRazem = new NumericUpDownDPI();
			this.numericUpDownNaliczonyRazem = new NumericUpDownDPI();
			this.label9 = new System.Windows.Forms.Label();
			this.numericUpDownNaleznyRazem = new NumericUpDownDPI();
			this.label18 = new System.Windows.Forms.Label();
			this.label17 = new System.Windows.Forms.Label();
			this.numericUpDownDoPrzeniesienia = new NumericUpDownDPI();
			this.numericUpDownDoWplaty = new NumericUpDownDPI();
