...
{
	public override string Nazwa => "🖫 Zapisz jako PDF KSeF" + (spisKSeF ? " [CTRL-P]" : "");
	public override bool CzyKlawiszSkrotu(Keys klawisz, Keys modyfikatory) => spisKSeF && modyfikatory == Keys.Control && klawisz == Keys.P;
