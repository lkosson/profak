	...
	where T : Rekord<T>
{
	...
	public DataGridViewTextBoxColumn DodajKolumneData(string wlasciwosc, string naglowek, string? format = null, int? szerokosc = 120, Func<T, string?>? tooltip = null) => DodajKolumne(wlasciwosc, naglowek, wyrownajDoPrawej: true, format: format ?? Wyglad.FormatDaty, szerokosc: szerokosc, tooltip: tooltip);
	public DataGridViewTextBoxColumn DodajKolumneKwota(string wlasciwosc, string naglowek, string? format = null, int? szerokosc = 80, Func<T, string?>? tooltip = null) => DodajKolumne(wlasciwosc, naglowek, wyrownajDoPrawej: true, format: format ?? Wyglad.FormatKwoty, szerokosc: szerokosc, tooltip: tooltip);
