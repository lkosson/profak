...
partial class FakturaEdytor : Edytor<Faktura>
{
	...
	private readonly TNumericUpDown numericUpDownBrutto;
	...
	private readonly TCheckBox checkBoxWDT;
	private readonly TCheckBox checkBoxWNT;
	private readonly TTextBox textBoxOpisZdarzenia;
	private readonly TTextBox textBoxNumerKSeF;
	private readonly TTextBox textBoxKSeFXML;
	private readonly TDatePicker dateTimePickerDataWystawienia;
	private readonly TDatePicker dateTimePickerDataSprzedazy;
	...
	private readonly TTextBox textBoxDataKSeF;
	private readonly TButton buttonDropDownKSeF;
	private readonly TMenuItem menuKSeFZapiszXML;
	private readonly TMenuItem menuKSeFZapiszWizualizacje;
	private readonly TMenuItem menuKSeFKopiujOdnosnik;
	...
	protected override void PrzygotujRekord(Faktura rekord)
	{
		...
		if (rekord.SposobPlatnosciRef.IsNull && rekord.CzySprzedaz) UstawSposobPlatnosci(rekord, Kontekst.Baza.SposobyPlatnosci.FirstOrDefault(sposobPlatnosci => sposobPlatnosci.CzyDomyslny));
