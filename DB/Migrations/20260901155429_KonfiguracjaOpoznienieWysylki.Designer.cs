...
namespace ProFak.DB.Migrations
{
    ...
    [Migration("20260901155429_KonfiguracjaOpoznienieWysylki")]
    partial class KonfiguracjaOpoznienieWysylki
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProFak.DB.Faktura", b =>
                {
                    ...
                    b.Property<int?>("FakturaRozliczeniowaId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("KwotaZaliczkiPrzedKorekta")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(0m);
                    ...
                    b.HasIndex("FakturaRozliczeniowaId");
            ...
            modelBuilder.Entity("ProFak.DB.Konfiguracja", b =>
                {
                    ...
                    b.Property<bool>("BlokadaZmianyKolumn")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("FormatCzasu")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue("");

                    b.Property<string>("FormatDaty")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue("");

                    b.Property<string>("FormatKwoty")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue("");
                    ...
                    b.Property<int>("OpoznienieWysylki")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("WysokoscWiersza")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ProFak.DB.Kontrahent", b =>
                {
                    ...
                    b.Property<int?>("DomyslnaWalutaId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ProFak.DB.RachunekKontrahenta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("RachunekKontrahenta", (string)null);
                });
            ...
            modelBuilder.Entity("ProFak.DB.Wplata", b =>
                {
                    ...
                    b.Property<bool>("CzyRozliczenie")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);

                    b.Property<bool>("CzyZaliczka")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("ProFak.DB.Faktura", b =>
                {
                    ...
                    b.HasOne("ProFak.DB.Faktura", "FakturaRozliczeniowa")
                        .WithMany("Zaliczki")
                        .HasForeignKey("FakturaRozliczeniowaId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("FakturaRozliczeniowa");
            ...
            modelBuilder.Entity("ProFak.DB.Kontrahent", b =>
                {
                    b.HasOne("ProFak.DB.Waluta", "DomyslnaWaluta")
                        .WithMany()
                        .HasForeignKey("DomyslnaWalutaId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("ProFak.DB.Faktura", b =>
                {
                    ...
                    b.Navigation("Zaliczki");
                });

            modelBuilder.Entity("ProFak.DB.Kontrahent", b =>
                {
                    b.Navigation("Rachunki");
                });
